...
\begin{footnotesize}
El método de análisis de vibración utilizado para el experimento fue el de desplazamiento de frecuencia, en el que la detección de los daños se basa en los cambios en la frecuencias naturales de la estructura, la base del método es que la frecuencia a la que vibra es una función de su rigidez, de modo que un cambio en este parámetro causada por cualquier daño que se refleja como una disminución en las frecuencias.\\

Medición de vibraciones se realizó el punto A por un acelerómetro ADXL335 con una sensibilidad eléctrica de 330 mV/g que operan en la fuente de alimentación 3,3 V y un rango de medición típica de \div 3,6 g.ADXL335 fue leído con el Intel Galileo utilizando el ADC AD7298 incorporado en él, con una resolución de 12 bits, con una frecuencia de muestreo de 200 Hz, este proceso se llevó a cabo por una rutina de C implementado, funcionando como una única secuencia en la aplicación del espacio de usuario. La figura 1 muestra el diagrama de conexión Intel Galileo y el acelerómetro ADXL335.
\end{footnotesize}
